  ...
  <br>
    <table class="table table-striped table-bordered">
      ...
      <tbody>
        ...
        <tr>
        <th scope="row" class="text-center"><a class="clickable" href="<?php echo site_url('accountant/AccountantLedgerController?accountName='.$row->accountName);?>"><?php echo $row->accountName?></a></th>
        <th scope="row" class="text-center"><a class="clickable" href="<?php echo site_url('accountant/AccountantLedgerController?accountName='.$row->accountName);?>"><?php echo $row->accountNumber?></a></th>
